defmodule Bonfire.Social.APIntegrationTest do
  ...
  test "follows get queued to federate" do
    ...
    assert_enqueued(worker: APPublishWorker, args: %{"context_id" => follow.id, "op" => "create", "user_id" => me.id})
  end
  ...
  test "likes get queued to federate" do
    ...
    assert_enqueued(worker: APPublishWorker, args: %{"context_id" => like.id, "op" => "create", "user_id" => me.id})
  end
  ...
  test "boosts get queued to federate" do
    ...
    assert_enqueued(worker: APPublishWorker, args: %{"context_id" => boost.id, "op" => "create", "user_id" => me.id})
  end
  ...
  test "messages get queued to federate" do
    ...
    assert_enqueued(worker: APPublishWorker, args: %{"context_id" => message.id, "op" => "create", "user_id" => me.id})
  end
