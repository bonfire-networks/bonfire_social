defmodule Bonfire.Social.Bonfire.Social.TrendingLinksTest do
  ...
  test "respects time_limit option and filters old posts", %{
    posts: posts,
    results: results,
    results_30days: results_30days
  } do
    ...
    old_links_long = Enum.filter(results_30days, &String.contains?(&1.path, "old"))
